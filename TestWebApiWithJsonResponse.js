...
export class TestWebAPIJsonResponse extends LitElement {
    ...
    static getMetaConfig() {
        return {
            ...
            controlName: 'TestWebApi Request - JSON Response',
...
customElements.define('test-webapi-jsonresponse', TestWebAPIJsonResponse);